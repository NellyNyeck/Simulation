 ...
 * test class for DC
 */
public class TestCOSMmapDC
{
    private static final int ROUTENUMBER = 8850;
    private COSMEnvironment m_env;

    @Before
    public void init() throws IOException
    {
        m_env = new COSMEnvironment( "src/test/resources/district-of-columbia-latest.osm.pbf", "src/test/DC", 38.995096, 38.807636,  -76.909537,  -77.111975 );
    }
    ...
    {
        final TestCOSMmapDC l_test = new TestCOSMmapDC();
        l_test.init();
