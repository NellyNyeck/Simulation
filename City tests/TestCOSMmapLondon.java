...
/**
 * test class for London
 */
public class TestCOSMmapLondon
{
    private static final int ROUTENUMBER = 78600;
    ...
    {
        m_env = new COSMEnvironment( "src/test/resources/great-britain-latest.osm.pbf", "src/test/GB", 51.616472, 51.428203,  0.075391,  -0.292342 );
    }
    ...
    {
        final TestCOSMmapLondon l_test = new TestCOSMmapLondon();
        l_test.init();
