...
/**
 * test class for paris
 */
public class TestCOSMmapParis
{
    private static final int ROUTENUMBER = 5250;
    ...
    {
        m_env = new COSMEnvironment( "src/test/resources/ile-de-france-latest.osm.pbf", "src/test/France", 48.901719, 48.816492,  2.413479,  2.226174 );
    }
    ...
    {
        final TestCOSMmapParis l_test = new TestCOSMmapParis();
        l_test.init();
