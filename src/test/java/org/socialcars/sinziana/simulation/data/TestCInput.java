...
public final class TestCInput
{
    ...
    {
        m_configuration = new ObjectMapper().readValue( new File( "src/test/resources/mitte-prenzlauerberg-friedrichshain-center.json" ), CInputpojo.class );
    }
    ...
    public void nodes()
    {
        ...
        Assert.assertTrue( l_nodes.size() == 975 );
        l_nodes.forEach( j ->
        {
    ...
    public void edges()
    {
        ...
        Assert.assertTrue( l_graph.getEdges().size() == 2182 );
