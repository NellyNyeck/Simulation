...
public final class TestCInput
{
    ...
    {
        m_configuration = new ObjectMapper().readValue( new File( "src/test/resources/berlin-mitte-center.json" ), CInputpojo.class );
    }
    ...
    public void nodes()
    {
        ...
        Assert.assertTrue( l_nodes.size() == 398 );
        l_nodes.forEach( j ->
        {
    ...
    public void edges()
    {
        ...
        Assert.assertTrue( l_graph.getEdges().size() == 871 );
