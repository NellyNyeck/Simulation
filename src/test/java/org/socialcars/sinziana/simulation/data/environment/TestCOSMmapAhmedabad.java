...
public class TestCOSMmapAhmedabad
{
    ...
    {
        m_env = new COSMEnvironment( "src/test/resources/india-latest.osm.pbf", "src/test/India", 23.127698, 22.903886,  72.704680,  72.454446 );
    }
    ...
    {
        final TestCOSMmapAhmedabad l_test = new TestCOSMmapAhmedabad();
        l_test.init();
