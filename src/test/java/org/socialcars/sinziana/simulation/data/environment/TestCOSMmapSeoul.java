...
public class TestCOSMmapSeoul
{
    ...
    {
        m_env = new COSMEnvironment( "src/test/resources/south-korea-latest.osm.pbf", "src/test/South Korea", 37.668705, 37.429832,  127.176021,  126.768159 );
    }
    ...
    {
        final TestCOSMmapSeoul l_test = new TestCOSMmapSeoul();
        l_test.init();
